...
import {  logout, reset, send_acc_verf_email, user_private_profile } from "../../redux/features/userSlice"
...
import { Followers,PostStats,SuccessMsg } from "../../cmps"
// const profile = {
//   name: "Ricardo Cooper",
//   imageUrl:
        ...
        <div className="relative z-0 flex flex-1 overflow-hidden">
          <main className="relative z-0 flex-1 overflow-y-auto focus:outline-none xl:order-last">
            <article>
              ...
              <PostStats posts={profile?.user?.posts} />
              {/* Followers */}
...
export default PrivateUserProf