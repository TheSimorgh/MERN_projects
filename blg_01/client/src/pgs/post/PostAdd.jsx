...
import { create_post } from "../../redux/features/postSlice";
...
const AddPost = () => {
  ...
  const token=userAuth?.userInfo?.data?.token
  ...
  const userToken =  Cookies.get("userInfo") 
  ? JSON.parse(Cookies.get("userInfo")) : null

  // console.log(categories.categories);
  // console.log(post);
  // console.log( userAuth?.userInfo?.data?.token);
  //   console.log("options");
