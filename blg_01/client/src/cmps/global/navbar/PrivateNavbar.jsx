...
import { logout, reset } from "../../../redux/features/userSlice";
...
const PrivateNavbar = () => {
   const {  userAuth,profile } = useSelector((state) => state?.user);
  //!dispatch
                    ...
                    <div>
                      <Menu.Button className="flex rounded-full bg-white text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">
                        ...
                        <img
                          ...
                          src={
                            userAuth?.userInfo?.data?.profilePicture ||
                            "https://cdn.pixabay.com/photo/2016/11/18/23/38/child-1837375_1280.png"
                          }
                          alt={userAuth?.userInfo?.data?.username}
                        />
                      </Menu.Button>
                    </div>
                    <Transition
              ...
              <div className="flex items-center px-4 sm:px-6">
                ...
                <div className="ml-3">
                  <div className="text-base font-medium text-gray-800">
                    {userAuth?.userInfo?.data?.username}
                  </div>
                  <div className="text-sm font-medium text-gray-500">
                    {userAuth?.userInfo?.data?.email}
                  </div>
                </div>
                {/* <button
                  type="button"
